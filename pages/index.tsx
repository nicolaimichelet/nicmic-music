...
const Home: NextPage = () => {
  ...
  return (
    <div>
      ...
      <main className="bg-gradient-to-b from-gray-700 via-gray-900 to-black w-screen h-screen flex flex-col items-center pb-16 justify-center px-4 md:px-20 text-center">
          <div className='mb-8'>
            <NicMicLogo twClassName='w-20 md:w-32' />
          </div>
        ...
        <div className='w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 px-4 mt-2 md:mt-20 overflow-auto mb-4'>
          ...
          <iframe src="https://open.spotify.com/embed/track/4KJCaLcZXnhyHv0ui0fCmh?utm_source=generator" width="100%" height="80" frameBorder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
          </div>
          <div className='w-full'>
